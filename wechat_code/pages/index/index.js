...
this.setData({
    ...
    const minsuxinxi = await list("minsuxinxi",
        {
                    page: 1,
                                                                                                                                                                                        }
    ...
    const minsuxinxiresult = minsuxinxi.data?.list?.map(item => {
    item.fangjiantupian = baseURL + "/" +
        item.fangjiantupian.split(",")[0];
    ...
    this.setData({
        homeminsuxinxiList:  minsuxinxiresult
    })
